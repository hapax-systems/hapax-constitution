...
axioms:
  ...
  - id: executive_function
    text: >
      ...
      Task initiation, sustained attention, and routine maintenance are the
      binding constraints the system exists to support. The system must
      compensate for these, not add to cognitive load.
    weight: 95
    type: hardcoded
    created: "2026-03-03"
    status: active
