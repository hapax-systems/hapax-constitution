...
| Repository | What to inspect | License |
|---|---|---|
| [hapax-mcp](https://github.com/hapax-systems/hapax-mcp) | MCP bridge to Hapax Logos APIs; authority stays with the underlying APIs | [MIT](https://github.com/hapax-systems/hapax-mcp/blob/main/LICENSE) |
| [reins](https://github.com/hapax-systems/reins) | Cockpit and API for inspecting delivery state and governed command paths | [Business Source License 1.1](https://github.com/hapax-systems/reins/blob/main/LICENSE) |
| [hapax-spine](https://github.com/hapax-systems/hapax-spine) | Runtime mechanisms for events, routing, receipts, quotas and projections | [Business Source License 1.1](https://github.com/hapax-systems/hapax-spine/blob/main/LICENSE) |
| [hapax-council](https://github.com/hapax-systems/hapax-council) | Source-visible research and runtime apparatus for inspection | [PolyForm Strict 1.0.0](https://github.com/hapax-systems/hapax-council/blob/main/LICENSE) |
| [hapax-constitution](https://github.com/hapax-systems/hapax-constitution) | Governance specification and enforcement/render tooling | [Split by path: CC BY-NC-ND 4.0 / Apache-2.0](https://github.com/hapax-systems/hapax-constitution/blob/main/LICENSE) |
| [hapax-research-ledger](https://github.com/hapax-systems/hapax-research-ledger) | Numeric observations with caveats and validation metadata | [CC0-1.0 for the declared data surface](https://github.com/hapax-systems/hapax-research-ledger/blob/main/LICENSE) |
...
|---|---|---|
| [hapax-officium](https://github.com/hapax-systems/hapax-officium) | Management decision-support apparatus for boundary review | [PolyForm Strict 1.0.0](https://github.com/hapax-systems/hapax-officium/blob/main/LICENSE) |
| [hapax-phone](https://github.com/hapax-systems/hapax-phone) | Android context bridge | [PolyForm Strict 1.0.0](https://github.com/hapax-systems/hapax-phone/blob/main/LICENSE) |
| [hapax-watch](https://github.com/hapax-systems/hapax-watch) | Wear OS sensor and awareness bridge | [PolyForm Strict 1.0.0](https://github.com/hapax-systems/hapax-watch/blob/main/LICENSE) |
| [hapax-assets](https://github.com/hapax-systems/hapax-assets) | Public asset mirror with attribution and per-asset notices | [CC BY 4.0 default; per-asset notices take precedence](https://github.com/hapax-systems/hapax-assets/blob/main/LICENSE-SCOPE.md) |
